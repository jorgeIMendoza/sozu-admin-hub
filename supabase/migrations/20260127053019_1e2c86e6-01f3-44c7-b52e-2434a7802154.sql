-- =====================================================
-- BACKUP: Guardar el RPC actual antes de modificarlo
-- Para rollback: DROP la función nueva y renombrar esta
-- =====================================================
CREATE OR REPLACE FUNCTION public.get_cuentas_cobranza_paginadas_backup(
...
-- =====================================================
-- ACTUALIZACIÓN: Solo cambia la lógica del campo "dueno"
-- Si tiene cuenta de mantenimiento activa -> comprador
-- Si no -> dueño original de la propiedad
-- =====================================================
...
BEGIN
  ...
  SELECT 
    ...
    ed.nombre::text AS estatus_disponibilidad_nombre,
    u.nombre::text AS vendedor,
    -- ÚNICO CAMBIO: Si tiene cuenta mantenimiento activa Y tiene comprador, mostrar comprador como dueño
    (CASE 
  ...
  LEFT JOIN entidades_relacionadas er_prop ON er_prop.id = prop.id_entidad_relacionada_dueno
  LEFT JOIN personas prop_dueno ON prop_dueno.id = er_prop.id_persona
  -- JOIN con el CTE de cuentas con mantenimiento
...
-- DROP FUNCTION public.get_cuentas_cobranza_paginadas;
-- ALTER FUNCTION public.get_cuentas_cobranza_paginadas_backup RENAME TO get_cuentas_cobranza_paginadas;