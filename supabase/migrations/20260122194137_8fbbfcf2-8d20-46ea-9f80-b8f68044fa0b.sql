...
-- Drop and recreate the function with all required fields including metraje, pagado, restante, cash
...
BEGIN
  ...
  SELECT 
    ...
    -- Cash limit (from UMAs)
    COALESCE(cc.numero_umas_limite * COALESCE(cc.valor_uma, 0), 0) as cash_limit,
    -- Cash paid
    COALESCE(
