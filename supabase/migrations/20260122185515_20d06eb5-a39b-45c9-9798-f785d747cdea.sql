-- Fix the function to exclude maintenance accounts (those with id_cuenta_cobranza_padre IS NOT NULL)
...
BEGIN
  ...
  -- Exclude maintenance accounts (those with id_cuenta_cobranza_padre IS NOT NULL)
  ...
  WHERE 
    cc.activo = p_activo
    AND cc.id_cuenta_cobranza_padre IS NULL  -- Exclude maintenance child accounts
