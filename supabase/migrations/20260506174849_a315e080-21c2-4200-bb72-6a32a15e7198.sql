...
BEGIN
  FOR r IN
    ...
    WHERE c.table_schema = 'public'
      ...
      AND (
        c.column_name ILIKE '%url%'
        OR c.column_name ILIKE '%logo%'
        OR c.column_name ILIKE '%foto%'
        OR c.column_name ILIKE '%imagen%'
        OR c.column_name ILIKE '%image%'
        OR c.column_name ILIKE '%portada%'
        OR c.column_name ILIKE '%brochure%'
        OR c.column_name ILIKE '%plano%'
        OR c.column_name ILIKE '%archivo%'
        OR c.column_name ILIKE '%documento%'
        OR c.column_name ILIKE '%file%'
        OR c.column_name ILIKE '%avatar%'
        OR c.column_name ILIKE '%pdf%'
        OR c.column_name ILIKE '%video%'
        OR c.column_name ILIKE '%media%'
        OR c.column_name ILIKE '%adjunto%'
        OR c.column_name ILIKE '%comprobante%'
        OR c.column_name ILIKE '%evidencia%'
        OR c.column_name ILIKE '%firma%'
        OR c.column_name ILIKE '%ine%'
        OR c.column_name ILIKE '%path%'
