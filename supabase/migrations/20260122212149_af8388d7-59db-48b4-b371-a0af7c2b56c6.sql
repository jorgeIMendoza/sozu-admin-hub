-- Fix: valor_uma is in cuentas_cobranza (cc), NOT ofertas (o)
...
BEGIN
  ...
  SELECT
    ...
    CASE WHEN cc.valor_uma IS NOT NULL AND cc.valor_uma > 0 THEN 8025 * cc.valor_uma ELSE NULL END AS cash_limit,
