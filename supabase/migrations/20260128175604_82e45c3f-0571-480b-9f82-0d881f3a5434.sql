...
-- Drop and recreate the function with the compradores filter properly implemented
...
BEGIN
  ...
  -- Count query with compradores filter
  ...
  WHERE cc.activo = p_activo
    ...
    -- Compradores filter: search in persona name
  ...
  -- Filtered accounts based on compradores
