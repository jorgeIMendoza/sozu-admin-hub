...
-- Fix the discrepancia calculation in get_cuentas_cobranza_paginadas
-- It should be: precio_final - total_acuerdos (not: total_acuerdos - total_pagado)
...
BEGIN
  ...
  SELECT 
    ...
    -- FIXED: discrepancia should be precio_final - total_acuerdos (not acuerdos - pagos)
