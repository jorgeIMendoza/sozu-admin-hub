-- Update the check_sat_notification_conditions function to call Edge Function instead of hardcoded webhook
...
BEGIN
  ...
  SELECT EXISTS (
    ...
    JOIN compradores_cuenta_cobranza ccc ON d.id_persona = ccc.id_persona
