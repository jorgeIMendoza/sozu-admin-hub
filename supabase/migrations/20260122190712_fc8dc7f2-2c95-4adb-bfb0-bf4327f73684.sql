...
-- Recreate with correct join path: cc -> ofertas -> propiedades (NOT cc -> propiedades directly)
...
BEGIN
  ...
  -- Join path: cuentas_cobranza -> ofertas -> propiedades -> edificios_modelos -> edificios -> proyectos
