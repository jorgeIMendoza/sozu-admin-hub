-- Fix: Use correct table name 'compradores' instead of 'compradores_cuenta_cobranza'
-- Also fix column name 'porcentaje_copropiedad' instead of 'porcentaje_propiedad'
