-- Corregir el query SQL del reporte para incluir el filtro de tipo correctamente
-- Usando FALSE en la parte de PROPIEDADES cuando tipo=Producto y FALSE en la parte de PRODUCTOS cuando tipo=Propiedad
UPDATE reportes 
