-- Drop existing function and recreate with correct schema
...
BEGIN
  ...
  compradores_info AS (
    SELECT 
      ...
      jsonb_agg(jsonb_build_object(
        ...
        'rfc', per.rfc,
        'porcentaje_copropiedad', oc.porcentaje_copropiedad
      )) AS compradores_json,
      (array_agg(per.nombre_legal ORDER BY oc.porcentaje_copropiedad DESC))[1] AS comprador_principal
  ...
  LEFT JOIN compradores_info ci ON ci.id_oferta = cc.id_oferta
