-- Modificar función crear_referencia_bancaria para incluir CLABEs de productos
...
BEGIN
    -- Obtener la última cuenta considerando TANTO propiedades COMO productos
    WITH todas_clabes AS (
        ...
        -- CLABEs de productos (apartado temporal)
        SELECT 
